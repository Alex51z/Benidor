...
CREATE TABLE CANTANTES (
	DNI VARCHAR(9) NOT NULL COMMENT 'DNI del cantante',
    NOMBRE VARCHAR(20) NOT NULL COMMENT 'Nombre del cantante',
    APELLIDOS VARCHAR(25) NOT NULL COMMENT 'Apellidos del cantante',
...
/*Se insertan los datos para la comunidad de Melilla*/
INSERT INTO CANTANTES (DNI, NOMBRE, APELLIDOS, TELEFONO, NOMBRE_CANCION)
...
CREATE TABLE COMUNIDAD_RANGOS (
	NOMBRECOMUNIDAD VARCHAR(50) NOT NULL,
	RANGO_1_9 INT NOT NULL,
    RANGO_10_17 INT NOT NULL,
    RANGO_18_25 INT NOT NULL,
    RANGO_26_40 INT NOT NULL,
    RANGO_41_65 INT NOT NULL,
    RANGO_MAS_65 INT NOT NULL,
    CONSTRAINT PK_COMUNIDAD_RANGOS PRIMARY KEY (NOMBRECOMUNIDAD)
);

Select * From COMUNIDAD_RANGOS;

CREATE TABLE VOTANTES (
NUMERO INT NOT NULL auto_increment,
COMUNIDAD VARCHAR(50) NOT NULL,
CANTANTE varchar(50),
constraint PK_VOTACION PRIMARY KEY (NUMERO)
);

CREATE TABLE CANTANTE_VOTOS (
NOMBRE VARCHAR(50) NOT NULL,
VOTOS INT NOT NULL,
CONSTRAINT PK_CANTANTE_VOTOS PRIMARY KEY (NOMBRE)
);